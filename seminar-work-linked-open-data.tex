...
\author{Kevin Haller\\
	\texttt{kevin.haller@student.tuwien.ac.at}} 
\date{March 2016} 
...
\subsection{Resource list management}
\label{related-work:rlm}
...
The application developer has the essential expertise for building software applications that meet the predefined specifications, which are influenced by the user requirements. Thereby the developer can also be a stakeholder. Computer science researchers can for example program solutions to simplify some work tasks for themselves or the whole research community at the university. 
...
This section discusses the proposed technical architecture (see figure \ref{fig:tac-high-level-architecture}), which uses a Linked Data approach to overcome the environment of data silos and to support the evolvement of a university-wide data space.

\paragraph{Data sources}
\label{technical-architecture-challenges:proposal:data-source}
with diverging data owners and/or data formats is a phenomena that can likely occur in an environment with multiple independent services. As mentioned earlier, the exploration of the data owner is an important task ... to be able to transform the corresponding data into Linked Data. A second important factor is the format of the data source, which is discussed in following.
\subparagraph{Semi structured files} 
...
% --------------------------------------------------------------------------------------------
%  Appendices: Linked Open Data
% --------------------------------------------------------------------------------------------

\section{Linked Open Data}
\label{linked-open-data-ap}

... a short description of linked (open) data and the formats ... 
